      ...
      cards: [
        {
          ...
          title: "Invoice Log",
          description:
            "One row per invoice. Client name, invoice number, issue date, due date, amount, and payment status. Conditional formatting highlights overdue rows automatically.",
        },
        {
          icon: "📊",
          title: "Monthly Summary",
          description:
            "Pulls from the Invoice Log to show total billed, collected, and outstanding per calendar month. Print this for your accountant at tax time.",
        },
        {
          icon: "🔣",
          title: "Formula Reference",
          description:
            "Every formula used in the template documented in plain English. Understand what's happening before you edit anything. 18 formulas total.",
        },
      ],
    },
